...
print(str) // str değeri ekranda gösteriliyor.


// let : Sonradan değiştirilemeyen veri türüdür. Sabittir. Değiştirilmeye zorlanırsa
// ya hata verir ya da var tipine dönüştür denilir.

let swiftDate = 2014 // çıkış tarihi

print(swiftDate) // ekranda gösteriliyor.
